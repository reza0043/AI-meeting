...
(function (root, factory) {
  ...
  /* the trend-line fit (fitTrend) and its price→row inverse (rowForPrice) were removed
     in 1.3.0: the line is not drawn anywhere and nothing is computed for it any more */
  ...
  return {
    ...
    components: components, textLines: textLines, version: '1.3.0',
